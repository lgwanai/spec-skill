...
Template for `NN-RESEARCH.md` - comprehensive ecosystem research before planning.
...
<user_constraints>
## User Constraints (from discovery.md)

**CRITICAL:** If discovery.md exists from phase discussion, copy locked decisions here verbatim. These MUST be honored by the planner.

### Locked Decisions
[Copy from discovery.md `## Design Decisions` section - these are NON-NEGOTIABLE]
- [Decision 1]
- [Decision 2]

### Claude's Discretion
[Copy from discovery.md - areas where researcher/planner can choose]
- [Area 1]
- [Area 2]

### Deferred Ideas (OUT OF SCOPE)
[Copy from discovery.md - do NOT research or plan these]
- [Deferred 1]
- [Deferred 2]

**If no discovery.md exists:** Write "No user constraints - all decisions at Claude's discretion"
</user_constraints>
...
**Structure:**
- Use XML tags for section markers (matches spec-skill templates)
...
**After creation:**
- File lives in phase directory: `.planning/phases/NN-name/NN-RESEARCH.md`
- Referenced during planning workflow
- The planning workflow loads it automatically when present
